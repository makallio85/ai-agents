...
return [
    ...
    'App' => [
        ...
        'mfaOtpTtl' => (int)env('MFA_OTP_TTL', 300),
        'mfaOtpLength' => (int)env('MFA_OTP_LENGTH', 6),
    ],
    ...
    'Session' => [
        ...
        'timeout' => 60,
        'handler' => [
            'engine' => 'App\Http\Session\ResilientDatabaseSession',
        ],
        'ini' => [
     ...
     * DSN format: redis://host:port or sync:// for in-process (testing)
     */
    'Queue' => [
        'default' => [
            'url' => env('QUEUE_DSN', 'redis://localhost:6379'),
        ],
    ],
