...
# also fixes the host-side ownership — no UID numbers needed. Root only
# ends up owning files because deploy.sh runs as sudo; this single step
# corrects that for every file in one go.
